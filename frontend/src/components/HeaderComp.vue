      ...
      <ul class="sidebar-nav d-flex align-content-center">
        <li class="dropdown" style="margin-left: 30px" v-if="isSignedIn">
          ...
          <ul class="dropdown-menu" style="background: #1D809F;" aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item" href="#" v-clipboard:copy="accountId">{{ shortAddressId }}
            ...
            <li v-if="isSignedIn"><a class="dropdown-item" href="#" @click.prevent="signOut">Sign Out
              <font-awesome-icon icon="arrow-right-from-bracket"/>
            </a></li>
          </ul>
        </li>
        <li class="sidebar-nav-item d-flex align-items-center" v-else>
          <a href="#" class="m-2" @click.prevent="login">Log In</a>
